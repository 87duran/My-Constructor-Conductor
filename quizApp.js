...
//Let's say three people signed up for our service, create 3 intances of User and add each to the users Array
  ...
  //code here
var chris = new User('Chris', 'duranduran@yahoo.com', 'iLikeToCode', 0);
var john = new User('John', 'john@hotmail.com', 'iLoveToCode', 0);
var bill = new User('Bill', 'findingbill@gmail.com', 'iHateToCode', 0);
users.push(chris, john, bill);
